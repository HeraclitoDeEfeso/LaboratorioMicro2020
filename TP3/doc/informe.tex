...
correspondiente al \textit{firmware} impreso en el microcontrolador.
Su explicación puede encontrarse en la sección de Análisis de 
funcionamiento.

\lstinputlisting[language=C,basicstyle=\ttfamily\scriptsize,numbers=left]{../src/programa3.c}
