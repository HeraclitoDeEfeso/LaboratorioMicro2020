...
descarga manuales, junto con señales de monitoreo contínuo
...
100 miliamperes que nos exigiría un relé de 5 voltios. 
...
microamperes, cumpliendo con las especificaciones del
fabricante\cite{bib:datasheet}.

Finalmente, como se indicó en la Introducción, el método
más eficáz para la implementación de un conversor 
...
funcionamiento puede encontrarse en la sección de Diseño.
...
% Los de verdad van a estar en la carpeta padre "../src/ejercicio1.c"
