...
\begin{ejercicios}
    ...
    Para este ejercicio utilizamos el circuito que se ilustra en la
    Figura \ref{fig:esquematico5}. En el cual se agrego un transistor,
    un motor dc y una bateria que entran en funcionamiento con el switch,
   es decir, cuando GP1 = 1.
    
    \begin{figure}[h]\centering

        \includegraphics[height=3cm]{esquematico5.png}
        \caption{Esquemático del circuito utilizado en el  
        \ref{ej:Resistor}}\label{fig:esquematico5}
    \end{figure}

    El código fuente de esta ejercicio se lista en 
...
al Ejercicio 3. La descripción de su funcionamiento puede encontrarse en
la sección de Diseño y Simulación.

\lstinputlisting[language=C,basicstyle=\ttfamily\scriptsize,numbers=left]{../ejercicio3.c}
\end{document}
