...
\makeatletter
% Es para usar o cambiar comandos que empiezan con @
\let\@afterindentfalse\@afterindenttrue
% Es para cambiar \@afterindentfalse por \@afterindenttrue
% que controla si se indenta el primer parrafo despues de un titulo
\makeatother
...
\newpage
\appendix
% Empezar el apéndice en una nueva pagina
\pagenumbering{gobble}
% Eliminamos la numeracion de paginas
...
\newpage
% Incluir salto de pagina de manera manual.
\section{}
